...
class _ContactSectionState extends State<ContactSection> {
        ...
        child: ConstrainedBox(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'Looking to collaborate on an architecture project or just want to say hi? My inbox is always open.',
              ...
              Flex(
                ...
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Expanded(flex: isMobile ? 0 : 1, child: _buildForm(context)),
                  ...
                  Expanded(
                    ...
                    child: Column(
                      children: [
                        ...
                        _buildContactInfoCard(contactData),
                      ],
                    ),
                  ),
                ],
          ...
          children: [
            Row(
              children: [
                ...
                Expanded(
                  child: _field('EMAIL', 'john@example.com', _emailCtrl),
                ),
              ],
            ),
            ...
            Align(
              ...
              child: _SendButton(isLoading: _isLoading, onPressed: _submit),
            ),
          ],
        ),
      ),
  ...
  Widget _buildContactInfoCard(ContactData contactData) {
    return Container(
      padding: const EdgeInsets.all(24),
      decoration: BoxDecoration(
        color: AppColors.surface,
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 32),
          _buildInfoRow(Icons.email_outlined, 'Email', contactData.email),
          const SizedBox(height: 24),
          _buildInfoRow(Icons.phone_outlined, 'Phone', contactData.phone),
          const SizedBox(height: 24),
          _buildInfoRow(
            Icons.location_on_outlined,
            'Location',
            contactData.location,
            subtitle: 'Available for remote opportunities.',
          ),
        ],
      ),
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            ...
            style: GoogleFonts.inter(color: AppColors.textDim, fontSize: 16),
          ),
          const SizedBox(height: 32),
          OutlinedButton(
            onPressed: () => setState(() {
